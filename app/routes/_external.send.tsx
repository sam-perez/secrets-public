...
const sends = [
    {
        ...
        encrypted_data: [
            ...
            {
                key: "API Secret",
                value: "kqkzqthhsrfdwaojqlsvrfcrastkaqveverrbsiunqqeefcmcxfptezavjvbsyumpxmdxdisxxjytonhkcnnjqtoasdqbehysfsddzlsgxenwcxuqazznnxfgfiqcia",
                type: "text",
            },
            {
                key: "API Story",
                value: "Check out our new font generator and level up your social bios. Need more? Head over to Glyphy for all the fancy fonts and cool symbols you could ever imagine.                ",
                type: "text",
            },
            {
                key: "Env file to use",
                        ...
                        <aside className="sticky top-6">
                            ...
                            <div>
                                {marketing.map((item, index) => (
                                    <div
                                        key={index}
                                        className="flex items-top muted space-x-4 mb-4"
                                    >
